			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<p class="bottom_nav_list-1"><input type="text" class="ui-text"  size="60" name="bottom_nav_list[1]" value="<?php echo ($extend['bottom_nav_list'][1]); ?>" >例：立即下单||<?php echo ($url["order"]); ?>&a=spu||edit</p>
