						...
						<tr>
                            ...
                            <td>
								...
								<div class="color-list">
									<?php if(!empty($info["colors"])): if(is_array($info["colors"])): $i = 0; $__LIST__ = $info["colors"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="rows clearfix"><label><?php echo lang('颜色_colon');?></label><input name="color_title[]" type="text" class="ui-text" value="<?php echo ($vo["title"]); ?>" size="6"><label> <?php echo lang('内容_colon');?></label><input name="color_value[]" type="text" class="ui-text" value="<?php echo ($vo["value"]); ?>" size="40"  id="colorvalue-<?php echo ($key); ?>"><div  class="image"><button id="colorbtn-<?php echo ($key); ?>" type="button" class="btn-upload" onclick="upload('#colorbtn-<?php echo ($key); ?>','#colorvalue-<?php echo ($key); ?>')"></button></div><select name='color_type[]'><option value='image' <?php if(($vo["type"]) == "image"): ?>selected<?php endif; ?>>图片</option></select><input type="button" class="ui-button" value="<?php echo lang('delete');?>" onclick="coloritemDel($(this))" /></div><?php endforeach; endif; else: echo "" ;endif; endif; ?>
								</div>
                            </td>
                        </tr>
						<tr>
...
function coloritemForm(){
	...
	select = btn + select;
//	var item = '<div class="rows clearfix"><label><?php echo lang('name_colon');?></label><input name="extend_title[]" type="text" class="ui-text" value="<?php echo ($info["title"]); ?>" size="6"><label> <?php echo lang('内容_colon');?></label><input name="extend_value[]" type="text" class="ui-text" value="" size="40">'+select+'<input type="button" class="ui-button" value="<?php echo lang('delete');?>" onclick="itemDel($(this))" /></div>';
	var item = '<div class="rows clearfix"><label><?php echo lang('颜色_colon');?></label><input name="color_title[]" type="text" class="ui-text" value="<?php echo ($vo["title"]); ?>" size="6"><label> <?php echo lang('内容_colon');?></label><input name="color_value[]" type="text" class="ui-text" value="" size="40" id="'+ valid +'">'+select+'<input type="button" class="ui-button" value="<?php echo lang('delete');?>" onclick="coloritemDel($(this))" /></div>'
