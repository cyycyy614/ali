	...
	<div class="alizi-page" style="padding-bottom: 60px;">
		...
		<div class="box">
			<div class="box-content">
				...
				<div class="alizi-content-title">
					...
					<div class="sales">
						<div class="price">NT$<ins><?php echo (floatval($info["price"])); ?></ins>
						</div>
						<div class="sales_info">
							<div>
								<del>NT$ <?php echo ($info["original_price"]); echo lang('yuan');?></del>
							</div>
							<div class="sales_num">
								<?php echo ($info["salenum"]); ?>件已售
							</div>
						</div>
					</div>
				...
				<div class="buy_now">
					<a href="<?php echo U('Order/spu',array('id'=>$info['sn'],'uid'=>$info['account']));?>" class=" btnPay" style="text-decoration: none;">立即購買</a>
				</div>
		...
		<div class="box">
			<div class="box-content alizi-detail-content">
				<?php if(!!$info['videoremark']){ echo '<div class="videoShow"><div class="videoTitle">視頻展示</div>'.$info['videoremark'].'</div>'; } ?>
...
<div style="background:#fff; height:100%;    margin: 0 10px;">
  <div class="bellows single" style="">
    ...
    <div class="bellows__item">
      ...
      <div class="bellows__content-wrapper" aria-hidden="true" style="display: none;"><div class="bellows__content">
        <p style="text-indent: 2em;">我們全天在這為你提供服務，電子郵箱：<a href="<?php echo ($aliziConfig["mail_to"]); ?>" style="text-decoration:none;outline:0;color:blue;"><?php echo ($aliziConfig["mail_to"]); ?></a></p>
    ...
    <div class="bellows__item">
      ...
      <div class="bellows__content-wrapper" aria-hidden="true" style="display: none;"><div class="bellows__content">
        ...
        <p style="text-indent: 2em;">2.由於質量原因產生的退換貨：至收到商品之日起7天內，向售後服務中心發送郵件至<a href="<?php echo ($aliziConfig["mail_to"]); ?>" style="text-decoration:none;outline:0;color:blue;"><?php echo ($aliziConfig["mail_to"]); ?></a>,，客服會在收到郵件後的1-3個工作日內受理 您的請求，退換貨所產生的運費由我方承擔。</p>
        <p>·如何取消訂單</p>
        <p style="text-indent: 2em;">取消訂單需要向售後服務中心發送郵件并注明相关原因，邮件内容应註明您的訂單號、姓名、電話。</p>
        <p style="text-indent: 2em;">收到商品後有任何疑問請聯繫在線客服或發郵件至<a href="<?php echo ($aliziConfig["mail_to"]); ?>" style="text-decoration:none;outline:0;color:blue;"><?php echo ($aliziConfig["mail_to"]); ?></a>,同時請告知您的姓名及聯繫方式及訂單編號，我們能快速的給您及時處理唷</p>
    ...
    <div class="bellows__item">
      ...
      <div class="bellows__content-wrapper" aria-hidden="true" style="display: none;"><div class="bellows__content">
        ...
        <p style="text-indent: 2em;">您可以發送電子郵件至<a href="<?php echo ($aliziConfig["mail_to"]); ?>" style="text-decoration:none;outline:0;color:blue;"><?php echo ($aliziConfig["mail_to"]); ?></a>以行使您的權利。我們將在合理的時間範圍內回复您的請求。我們將採取一切合理措施確保您的個人數據正確且最新。</p>
        <p>·我們如何保護您的信息？</p>
  ...
  <div style="text-align:center;margin:5px;font-size:74%">
    ...
    <p></p>
    <img src="../Public/../Order/img/buttom.jpg" width="100%">
  </div>
</div>
...
<script type="text/javascript" src="__PUBLIC__/Alizi/seajs/jquery/jquery.min.js"></script>
	...
	<?php $showNav = (int)$template['extend']['bottom_nav']; if(!empty($showNav)){ if($showNav==1){ $style = "style='width:100%'"; }elseif($showNav==2){ $style = "style='width:49%'"; }else{ $style = '';} $html = '<div class="alizi-foot-nav"><a class="alizi-up" href="#">'.lang('top').'</a><ul>'; var_dump($template['extend']); for($i=1;$i<=$showNav;$i++){ $nav = explode('||',$template['extend']['bottom_nav_list'][$i]); $class = isset($nav[2])?'icon '.$nav[2]:''; $html .= '<li class="foot-nav-'.$i.'"'.$style.'><a href="'.$nav[1].'"><strong class="'.$class.'">'.$nav[0].'</strong></a></li>'; } echo $html.'</ul></div>'; } ?>
</div>
<?php if(isWeixin()): ?><script type="text/javascript">
seajs.use(['jquery'], function($) {
	$(function(){
