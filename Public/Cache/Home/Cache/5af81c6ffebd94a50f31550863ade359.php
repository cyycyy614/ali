...
<title>PHP订单系统 - order.chmzw.com</title>
...
<div class="header">
<div class="head">
<div class="logo"><a href="http://order.chmzw.com" target="_blank"><img src="__PUBLIC__/Assets/img/logo.png" alt="PHP订单系统" /></a></div>
<div class="menu">PHP订单系统安装 - order.chmzw.com</div>
</div>
</div>
...
<div class="main">
<p>欢迎使用 <span style="color:#F00; font-size:18px; font-weight: bolder">PHP订单系统（锦尚中国源码论坛）</span></p>
<p>PHP订单系统，是采用国内优秀框架ThinkPHP开发的导航程序，安全，高效，界面优美。</p>
<p>在安装之前，您需要准备以下信息：</p>
<ol>
<li>数据库名</li>
<li>数据库用户用户名</li>
...
﻿<!--footer-->
<div class="footer">Powered by PHP订单系统（<a href="http://order.chmzw.com" target="_blank">order.chmzw.com</a>）</div>
</body>
</html>